...
<head>
    ...
    <link rel="stylesheet" href="{{ url('asset/css/line-awesome.css') }}">
    ...
    <link rel="stylesheet" href="{{ url('asset/css/jqvmap.css') }}">
    ...
    <script src="{{ url('asset/js/jquery.repeatable.js') }}"></script>
...
<body>
            ...
            <div class="container-fluid">
                <div class="main-menu-content">
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="logo-box">
                                <a href="{{ url('/') }}" class="logo"><img src="{{ url('asset/images/logo/logo-company.png') }}" alt="logo"></a>
                        ...
                        <div class="col-lg-10">
                            <div class="menu-wrapper">
                                <nav class="main-menu">
                                    <ul>
                                        @if(Auth::check()  && !in_array('products', $act))
                                        <a href="{{ url('/products') }}" style="font-style: italic;">My Portal</a>
                                        @elseif(!Auth::check() && in_array('register', $act))
                                        <li><a href="{{ url('/login') }}">login</a></li>
                                        @elseif(!Auth::check() && in_array('login', $act))
                                            ...
                                            <div class="notification-item user-action-item">
                                                ...
                                                <div class="dropdown">
                                                    <button class="notification-btn dot-status online-status dropdown-toggle" type="button" id="userDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <img src="{{ url('asset/images/default_avatar.png') }}" alt="Profile" style="width: 40px; height: 40px">
                                                    </button>
                                                    <div class="dropdown-menu" aria-labelledby="userDropdownMenu">
                                                        ...
                                                        <div class="mess-dropdown">
                                                            <div class="mess__title d-flex align-items-center">
                                                               <!--  <div class="image">
                                                                    <a href="#">
                                                                        <img src="@if(Auth::user()->pic_dynamicName){{ url('application/public/uploads/profile_pics/users/'.Auth::user()->pic_dynamicName) }}@else{{ url('asset/images/user_icon.jpg') }}@endif" alt="Profile" style="width: 40px; height: 40px">
                                                                    </a>
                                                                </div> -->
                                                                <div class="content">
    ...
    <script src="{{ url('asset/js/doughnut-chart.js') }}"></script>
    <script src="{{ url('asset/js/smooth-scrolling.js') }}"></script>
    <script src="{{ url('asset/js/date-time-picker.js') }}"></script>
    <script src="{{ url('asset/js/emojionearea.min.js') }}"></script>
    <script src="{{ url('asset/js/jquery.filer.min.js') }}"></script>
    <script src="{{ url('asset/js/tooltipster.bundle.min.js') }}"></script>
    <script src="{{ url('asset/js/jquery.filer.min.js') }}"></script>
    ...
    <script src="{{ url('asset/js/jquery.vmap-script.js') }}"></script>
    <script src="{{ url('asset/js/progress-bar.js') }}"></script>
    <script src="{{ url('asset/js/date-time-picker.js') }}"></script>
    <script src="{{ url('asset/js/emojionearea.min.js') }}"></script>
    <script src="{{ url('asset/js/animated-skills.js') }}"></script>
