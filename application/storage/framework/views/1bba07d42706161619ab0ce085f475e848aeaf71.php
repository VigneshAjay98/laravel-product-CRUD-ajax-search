                        ...
                        <div class="course-carousel owl-dot-and-nav">
                            <div class="card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="./course_details" class="card__img"><img src="images/img9.jpg" alt=""></a>
                                </div><!-- end card-image -->
                                <div class="card-content">
                                    ...
                                    <h3 class="card__title">
                                        <a href="./course_details">User Experience Design - Adobe XD UI UX Design</a>
                                    </h3>
                            ...
                            <div class="card-item card-preview" data-tooltip-content="#tooltip_content_2">
                                <div class="card-image">
                                    <a href="./course_details" class="card__img"><img src="images/img11.jpg" alt=""></a>
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="card__title">
                                        <a href="./course_details">The Complete Digital finance Marketing Course</a>
                                    </h3>
                                    <p class="card__author">
                            ...
                            <div class="card-item card-preview" data-tooltip-content="#tooltip_content_3">
                                <div class="card-image">
                                    <a href="./course_details" class="card__img"><img src="images/img12.jpg" alt=""></a>
                                </div><!-- end card-image -->
                                <div class="card-content">
                                    <p class="card__label">
                                        <span class="card__label-text">all levels</span>
                                    ...
                                    <h3 class="card__title">
                                        <a href="./course_details">Complete Python Bootcamp: Go from zero to hero</a>
                                    </h3>
                                    <p class="card__author">
                            ...
                            <div class="card-item card-preview" data-tooltip-content="#tooltip_content_5">
                                <div class="card-image">
                                    <a href="./course_details" class="card__img"><img src="images/img8.jpg" alt=""></a>
                                    <div class="card-badge">
    ...
    <div id="tooltip_content_1">
        <div class="card-item">
            <div class="card-content">
                ...
                <h3 class="card__title">
                    <a href="./course_details">WordPress for Beginners – Master WordPress</a>
                </h3>
                <p class="card__label">
                ...
                <div class="btn-box w-100 text-center mb-3">
                    <a href="./course_details" class="theme-btn d-block">Preview this course</a>
                </div>
                <div class="card-price-wrap d-flex justify-content-between align-items-center">
    ...
    <div id="tooltip_content_2">
        <div class="card-item">
            <div class="card-content">
                ...
                <h3 class="card__title">
                    <a href="./course_details">Learn Ethical Hacking from Scratch Your Stepping</a>
                </h3>
                <p class="card__label">
                    <span class="card__label-text mr-1">BESTSELLER</span>
    ...
    <div id="tooltip_content_3">
        <div class="card-item">
            <div class="card-content">
                ...
                <h3 class="card__title">
                    <a href="./course_details">Microsoft SQL Server 2019 for Everyone</a>
                </h3>
                <p class="card__label">
                    <span class="card__label-text mr-1">BESTSELLER</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\learning\application\resources\views/home.blade.php ENDPATH**/ ?>