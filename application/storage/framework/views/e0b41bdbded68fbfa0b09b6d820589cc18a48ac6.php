                                                ...
                                                <div class="card-box-shared-body">
                                                    <div class="contact-form-action">
                                                            <div class="row">
                                                                ...
                                                                <?php if(@$feed_completes): ?>
                                                                <?php if(array_search('tick', array_column($feed_completes, 'type'))): ?>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <table class="table table-bordered star" style="table-layout: fixed; width: 100%;">
                                                                        <tbody>
                                                                            <?php $__currentLoopData = $feed_completes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php if($value['type']=='star'): ?>
                                                                            <tr>
                                                                                ...
                                                                                <td align="center">
                                                                                <?php
                                                                                 echo"<pre>"; print_r($value['value']); exit;
                                                                                    $n = 1;
                                                                                    while($n <= 5){
                                                                                      if($n <= $value['value'] ) { ?>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="star_rating" align="center">
                                                                                    ...
                                                                                    <input type="hidden" name="star_quer[]" class="star_quer-value" value="<?php echo e($key); ?>">
                                                                                </td>
                                                                            </tr>
                                                                                <?php endif; ?>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <table class="table table-bordered">
                                                                      ...
                                                                      <tbody>
                                                                  <?php $__currentLoopData = @$feed_completes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($value['type']=='tick'): ?>
                                                                        <tr>
                                                                            <th scope="row"><?php echo e($value['content']); ?></th>
                                                                         <?php
                                                                         // echo"<pre>"; print_r($feed_complete); exit;
                                                                            $n = 1;
                                                                            while($n <= 5){
                                                                              if($n == $value['value'] ) { ?>
                                                                                <td><i class="la la-check tick primary-color-2 d-flex align-items-center justify-content-center" style="font-size: 26;"></i></td>
                                                                              <?php }
                                                                              else { ?>
                                                                                <td></td>
                                                                              <?php }
                                                                        ...
                                                                        <?php $__currentLoopData = $feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <tr class="course_feedTick">
                                                                              <th scope="row"><?php echo e($key); ?></th>
                                                                                  <td class="tick_box" data-tick="1"></td>
                                                                                  <td class="tick_box" data-tick="2"></td>
                                                                                  <td class="tick_box" data-tick="3"></td>
                                                                                  <td class="tick_box" data-tick="4"></td>
                                                                                  <td class="tick_box" data-tick="5"></td>
                                                                                  <input type="hidden" name="ticks[]" class="tick-value">
                                                                                  <input type="hidden" name="tick_quer[]" class="tick_quer-value" value="<?php echo e($key); ?>">
                                                                            </tr>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <table class="table table-bordered">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <th><textarea class="form-control" id="exampleFormControlTextarea1" name="textbox[]" style="border: none; padding: 0;" required></textarea></th>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
...
$(document).ready(function() {
      ...
      SetRatingStar();
       ...
       $(document).on('click', '.tick_box', function() {
        $(this).siblings('input.tick-value').val($(this).data('tick'));
      });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7.4.13\htdocs\learning\application\resources\views/course_view.blade.php ENDPATH**/ ?>