                ...
                <div class="card-box-shared">
                    ...
                    <div class="card-box-shared-body">
                        <div class="contact-form-action">
                            ...
                            <form method="POST" id="login_form" action="<?php echo e(url('/login/submit')); ?>">
                            <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-box">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Office\Projects\Environments\xampp\htdocs\product\application\resources\views/auth/login.blade.php ENDPATH**/ ?>