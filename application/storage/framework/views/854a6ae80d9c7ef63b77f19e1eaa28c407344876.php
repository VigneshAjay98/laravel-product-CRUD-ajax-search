            ...
            <div class="container-fluid">
                <div class="main-menu-content">
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="logo-box">
                                <a href="<?php echo e(url('/')); ?>" class="logo"><img src="<?php echo e(url('asset/images/logo/logo-company.png')); ?>" alt="logo"></a>
                        ...
                        <div class="col-lg-10">
                            <div class="menu-wrapper">
                                <nav class="main-menu">
                                    <ul>
                                        <?php if(Auth::check()  && !in_array('products', $act)): ?>
                                        <a href="<?php echo e(url('/products')); ?>" style="font-style: italic;">My Portal</a>
                                        <?php elseif(!Auth::check() && in_array('register', $act)): ?>
                                        <li><a href="<?php echo e(url('/login')); ?>">login</a></li>
                                        <?php elseif(!Auth::check() && in_array('login', $act)): ?>
                                            ...
                                            <div class="notification-item user-action-item">
                                                ...
                                                <div class="dropdown">
                                                    <button class="notification-btn dot-status online-status dropdown-toggle" type="button" id="userDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <img src="<?php echo e(url('asset/images/default_avatar.png')); ?>" alt="Profile" style="width: 40px; height: 40px">
                                                    </button>
...
</html><?php /**PATH D:\Office\Projects\Environments\xampp\htdocs\product\application\resources\views/layouts/app.blade.php ENDPATH**/ ?>